// Original AbsoluteDriveAdv.java File From BroncBotz3481/YAGSL-Example Release 2025.7.2
...
public class AbsoluteDriveAdv extends Command {
  ...
  public void execute() {
    ...
    translation = SwerveMath.limitVelocity(translation, swerve.getFieldVelocity(), swerve.getPose(),
        YAGSLConstants.LOOP_TIME, YAGSLConstants.ROBOT_MASS,
        List.of(YAGSLConstants.CHASSIS),
    ...
    if (headingX == 0 && headingY == 0 && Math.abs(headingAdjust.getAsDouble()) > 0) {
      resetHeading = true;
      swerve.drive(translation, (YAGSLConstants.TURN_CONSTANT * -headingAdjust.getAsDouble()), true);
    } else {
